...
export const FEATURES = {
  ...
  supBooking: "internal", // paddle-boarding discipline switch + SUP availability (dev-only while built out)
};
...
export const APP_RELEASE = "v88"; // release/version — bump together with sw.js CACHE
