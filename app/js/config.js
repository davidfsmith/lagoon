...
export const FEATURES = {
  notifications: "on", // push notifications — GA (live for everyone; enable in Settings → Notifications)
};
...
export const APP_RELEASE = "v64"; // release/version — bump together with sw.js CACHE
