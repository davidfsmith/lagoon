...
export const FEATURES = {
  ...
  rum: "on", // GA — first-party cookieless usage analytics (opt-out in Settings, DNT honoured)
...
export const APP_RELEASE = "v115"; // release/version — bump together with sw.js CACHE
