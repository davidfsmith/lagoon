...
export const FEATURES = {
  prefsSync: "internal", // notification-prefs save status + reconcile (dev-only while built out)
};
...
export const APP_RELEASE = "v76"; // release/version — bump together with sw.js CACHE
