...
const ASSETS = ["./", "./index.html", "./manifest.json",
  ...
  "./js/views/login.js", "./js/views/agenda.js", "./js/views/day.js", "./js/views/account.js", "./js/views/format.js", "./js/views/settings.js", "./js/views/lastminute.js", "./js/views/history.js", "./js/views/cafe.js", "./js/views/share.js", "./js/views/book.js"];
